...
const Hero = () => (  
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>BOUTIQUE RISK MANAGEMENT AND LOSS PREVENTION SERVICES CUSTOMIZED FOR THE INDIVIDUAL NEEDS OF EACH CLIENT</p>
      </div>
      <div>
        <img src={handshake} alt="handshake" className="relative w-full h-[auto] transform scale-150 bottom-20 z-[5]"/>  {/* max-w-[64rem] */}
